<template>
    <div class="movie-list">
        <div class="item" @click="goCinemMovie(item.id,item.nm,item.globalReleased)" :id="item.id"
            ...
            <div class="content underline">
                <div class="detail-box">
                    ...
                    <div class="detail">
                        ...
                        <div v-else-if="!item.globalReleased && !item.sc && !item.enm && !item.pubDesc"
                             class="score line-ellipsis">
