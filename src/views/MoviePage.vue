    ...
    <div class="movie-page">
        <div class="top-bar" underline>
            <div @click="goCityList" class="item city">
                {{city}}
                <span class="city-below iconfont iconfont-below-s"></span>
            </div>
            <div class="item" :class="{active:currComponent=='ShowingUp'}" @click="changeComponent('ShowingUp')">
                正在上映
            </div>
            <div class="item" :class="{active:currComponent=='UpComing'}" @click="changeComponent('ShowingUp')">
                即将上映
            </div>
